...
VALUES
  ('Tech Portfolio', 5015.7521, null, '0x6A09F56C7F3F1A7F0D8C4B6A1F1', 1),
  ('Finance Portfolio', 7515.25123, 15.8, null , 2),
  ('Real Investment', 120051.5012, 8.2, null, 3),
  ('Global Fund', 90062.84890, 12.5, '0xC4D2C3B3E2F1A7D8C4B6A1F1', 4),
  ('Crypurrency Mix', 6515.40849, 18.7123, '0x2F1A7F0D8C4B6A1B6A1F1', 5),
  ('Energy Holdings', 80023.60123, 14.5123, '0x3D1C4D2C3B3E2D8C4B6A1F1', 6),
  ('Hehcare Investments', 100231.95123, 20.1, null, 7),
  ('Development Fund', 110015.20231, 10.2319, '0xC4D2C1A7F0D8C4B6A1F1', 8),
  ('Emerging Portfolio', 95049.70123, null, '0xB6A1F10x6E2F1A7F0D81', 9),
  ('Disified Holdings', 8500.55, 16.8, '0x7F0D8C4B6A1F10xF1', 10),
  ('Technology  Fund', 70061.45, 11.2, '0xE2F1A7F0D8C0D8C4B6A1F1', 11),
  ('Goods Investments', 8802.65, null, null, 12),
  ('Global Fund', 11803.75, 13.7, '0xB3E2F1A7F0D8F0D8C4B6A1F1', 13),
  ('Bioch Holdings', 7230.50, 21.8, '0x2F1A7F0D8C4B6C4B6A1F1', 14),
  ('Global Stocks', 1051230.90, null, null, 15),
