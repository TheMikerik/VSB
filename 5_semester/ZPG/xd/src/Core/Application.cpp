...
{
    std::cout << "S0: " << scenes.size() << std::endl;
    scenes.emplace_back(Scene1(camera));
    std::cout << "S1: " << scenes.size() << std::endl;
    scenes.emplace_back(Scene2(camera));
    std::cout << "S2: " << scenes.size() << std::endl;
    // scenes.emplace_back(std::make_shared<Scene3>(camera, pointLight));
    // scenes.emplace_back(std::make_shared<Scene4>(camera, pointLight));
    // scenes.emplace_back(std::make_shared<Scene5>(camera, fireflies));
}
