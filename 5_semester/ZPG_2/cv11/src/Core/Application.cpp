...
#include "Scenes/Scene_trans_test.h"
...
void Application::createScenes()
{
    ...
    auto scene_trans_test = std::make_shared<Scene_trans_test>(camera);
    auto scene_arcade = std::make_shared<Scene_arcade>(camera);
    auto scene_solar_system = std::make_shared<Scene_solar_system>(camera);
    auto scene_bezier = std::make_shared<Scene_bezier>(camera);
    
    scenes.emplace_back(scene1);
    scenes.emplace_back(scene3);
    scenes.emplace_back(scene5);
    scenes.emplace_back(scene6);
    scenes.emplace_back(scene_trans_test);
    scenes.emplace_back(scene_arcade);
    scenes.emplace_back(scene_solar_system);
    scenes.emplace_back(scene_bezier);
}
