...
abstract class MyLangListener extends ParseTreeListener {
  ...
  /// Enter a parse tree produced by [MyLangParser.appendExpr].
  /// [ctx] the parse tree
  void enterAppendExpr(AppendExprContext ctx);
  /// Exit a parse tree produced by [MyLangParser.appendExpr].
  /// [ctx] the parse tree
  void exitAppendExpr(AppendExprContext ctx);
